#	This piece of program gives the precision and threshold for a fixed recall of 0.24
#
#
################################################################
import csv
...
all_files.append('../4_Results/1_Data/1_Results/Unlabeled_New_Feats')
all_files.append('../4_Results/1_Data/1_Results/Ground_Truth_New_Feats')
